...
static const uint256 hashGenesisBlock("0x000009ee81dd50b146a23c58670c5c95f47d03f2896bc147ec58c13bf9ba6a67");
...
public:
    ...
    {
        // PeaceCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // PeaceCoin: get transaction coin age
...
public:
    ...
    // PeaceCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // PeaceCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // PeaceCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // PeaceCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // PeaceCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // PeaceCoin: block index flags
    enum  
    {
