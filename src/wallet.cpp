...
// PeaceCoin: total coins staked (non-spendable until maturity)
...
// PeaceCoin: check 'spent' consistency between wallet and txindex
// PeaceCoin: fix wallet spent state according to txindex
...
// PeaceCoin: disable transaction (only for coinstake)
